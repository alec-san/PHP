...
if (isset($_GET["btnbuscar"])) {
    ...
    FROM tab_tarefas as t 
    inner join tab_usuarios as u 
    where t.id_usuario = u.id and t.id_usuario ='$id' and t.status_tarefa='0'";
}
...
and t.id_usuario ='$id' and t.status_tarefa ='0' 
            ...
            <div class="row">
                ...
                while ($linha = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-sm-2 mb-3 mb-sm-0">
                        <?php 
                            $dataEntradabanco = $linha["data_tarefa"];                        
                            $dataEntrada = date_create($dataEntradabanco);
                            $dataFormatada = $dataEntrada->format("Y-m-d");
                            
                            $dataAgora = date("Y-m-d");
                            if($dataFormatada == $dataAgora ){
                        ?>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item">
                        ...
                        if ($pagAnt != 0) {
                            ?>
                            <a class="page-link" href="index.php?pagina= <?= $pagAnt ?>" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        <?php } else { ?>
                            <a class="page-link bg-dark text-white" aria-label="Previous">
                                <span aria-hidden="true"> &laquo; </span>
                            </a>
                        <?php } ?>
                    </li>

                    <!-- lista a quantidade de páginas e enumera  -->
                    ...
                    <!-- Paginação do anterior  -->
                    <li class="page-item">
                        <?php
                        if ($pagPos <= $numero_de_pag) {
                            ?>
                            <a class="page-link" href="index.php?pagina=<?= $pagPos ?>" aria-label="Next">
